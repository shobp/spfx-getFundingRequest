...
import NewRequestFunding from './NewFR/NewRequestFunding';
...
export default class ViewAllItems extends React.Component<IViewAllItemsProps, IViewAllItemsState> {
  ...
  constructor(props: IViewAllItemsProps){
    ...
    console.log("Site Url : " , props.siteUrl);
    this.state ={
      items:[],
                    ...
                    <div>    
                      <nav className="navbar navbar-expand-lg navbar-light bg-light">    
                        <ul className="navbar-nav mr-auto">    
                          ...
                          <li>
                            <Link to={'/list'} className="nav-link">My Requests</Link>
                          </li>
                          <li>
                            <Link to={'/add'} className="nav-link">New Item </Link>
                          </li>
